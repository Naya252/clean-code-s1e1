...
var todoTasks=document.getElementById("todo-tasks");//ul of main__todo
...
var editTask=function(){
  ...
  var editInput=listItem.querySelector(".tasks__item_input");
  var label=listItem.querySelector(".tasks__item_label");
